...
function LiquidationScenarios(props) {
  ...
  const { data, isLoading, isPreviousData, isError, ErrorFallbackComponent } = useFetch(
    "aave/risk/liquidation-scenario/relative/",
    { type, sum },
  ...
  return (
    <div>
      <div className="d-flex flex-direction-row justify-content-between align-items-center mb-4">
        <h3 className="flex-grow-1">relative liquidations curve</h3>
        <TimeSwitch
...
export default withErrorBoundary(LiquidationScenarios);
