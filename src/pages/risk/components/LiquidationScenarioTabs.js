...
import LiquidationScenarios from "./LiquidationScenarios.js";

function LiquidationScenarioTabs(props) {
            ...
            tabs={[
              {
                ...
                content: <LiquidationScenarios type={type} sum="absolute" />,
              },
              {
                title: <FontAwesomeIcon icon={faChartArea} />,
                content: <LiquidationScenarios type={type} sum="bar" />,
              },
            ]}
          />
        </Col>
...
export default withErrorBoundary(LiquidationScenarioTabs);
